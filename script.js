...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "svc.vat.t": "VAT & Tax Returns",
      "svc.vat.d": "MTD-ready VAT and returns prepared and filed on time, in line with current and upcoming UK regulations.",
    ...
    tr: {
      ...
      "svc.vat.t": "KDV & Vergi Beyanları",
      "svc.vat.d": "MTD uyumlu KDV ve beyannameler; güncel ve yaklaşan UK mevzuatına uygun, zamanında hazırlanır ve verilir.",
      "svc.pay.t": "Bordro & İK",
